...
swith the release of Letraset sheets containing Lorem Ipsum passages,
...
export async function getProducts(query) {
    ...
    let products = await localforage.getItem("Product");
    if(!products){
...
export async function createProduct(newProduct) {   
    ...
    if (!newProduct || (newProduct.id && products.findIndex((e) =>   e.id === newProduct.id) !== -1)    
    ) {          
